...
class DrawdownProtection:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.max_daily_drawdown_pct = risk_limits.get('max_daily_drawdown_pct', 0.15)  # 15%
        self.max_total_drawdown_pct = risk_limits.get('max_total_drawdown_pct', 0.25)  # 25%
    ...
    def check_consecutive_losses(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'message': (
                ...
                f"(limit: {self.max_consecutive_losses})" if triggered else
    ...
    def check_hourly_loss(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'message': (
                ...
                f"(limit: ${self.max_hourly_loss:.2f})" if triggered else
                f"Hourly loss: ${total_hourly_loss:.2f}/${self.max_hourly_loss:.2f}"
            )
        }
    ...
    def check_daily_drawdown(self, current_capital: float) -> Dict[str, Any]:
        ...
        daily_drawdown_pct = abs(daily_pnl) / self.daily_start_capital if daily_pnl < 0 else 0
        ...
        return {
            ...
            'message': (
                ...
                f"(limit: {self.max_daily_drawdown_pct*100:.1f}%)" if triggered else
                f"Daily drawdown: {daily_drawdown_pct*100:.1f}%/{self.max_daily_drawdown_pct*100:.1f}%"
            )
        }
    ...
    def check_total_drawdown(self, current_capital: float) -> Dict[str, Any]:
        ...
        total_drawdown_pct = total_drawdown / self.peak_capital if total_drawdown > 0 else 0
        ...
        return {
            ...
            'message': (
                ...
                f"(limit: {self.max_total_drawdown_pct*100:.1f}%)" if triggered else
                f"Drawdown from peak: {total_drawdown_pct*100:.1f}%/{self.max_total_drawdown_pct*100:.1f}%"
            )
        }
    ...
    def check_win_rate(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'message': (
                ...
                f"(minimum: {self.min_win_rate*100:.1f}%)" if triggered else
                f"Win rate: {win_rate*100:.1f}%/{self.min_win_rate*100:.1f}%"
            )
        }
    ...
    def _clean_old_hourly_losses(self) -> None:
        ...
        self.hourly_losses = [
            (timestamp, loss) for timestamp, loss in self.hourly_losses
