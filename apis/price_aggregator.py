...
class PriceAggregator:
    ...
    def _calculate_consensus(self, prices: Dict[str, float], symbol: str) -> Optional[Dict]:
        """
        ...
        return {
            ...
            'price_range': {
                ...
                'spread_percent': (max(valid_prices) - min(valid_prices)) / final_price * 100
            },
            'timestamp': datetime.now().isoformat()
        }
    ...
    def get_price_comparison(self, symbol: str) -> Optional[Dict]:
        ...
        prices = [
            s['price'] for s in comparison['sources'].values() 
        ...
        if prices:
            comparison['statistics'] = {
                ...
                'spread_percent': (max(prices) - min(prices)) / statistics.median(prices) * 100
            }
