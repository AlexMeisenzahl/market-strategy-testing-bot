...
class CoinGeckoClient:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if coin_id in data and vs_currency in data[coin_id]:
                    ...
                    if self.logger:
                        self.logger.log_warning(f"CoinGecko: No price data for {coin_id}")
                    return None
            else:
                if self.logger:
                    self.logger.log_error(f"CoinGecko API error: HTTP {response.status_code}")
                return None
    ...
    def get_multiple_prices(self, coin_ids: List[str], vs_currency: str = 'usd') -> Dict[str, float]:
        """
            ...
            if response.status_code == 200:
                ...
                if coin_id in data:
                    ...
                    return {
                        ...
                        'change_24h': float(coin_data.get(f'{vs_currency}_24h_change', 0)),
