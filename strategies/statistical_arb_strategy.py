...
class CorrelationTracker:
    ...
    def __init__(self, market_id_1: str, market_id_2: str,
                 window_size: int = 100):
        """
...
class StatisticalArbOpportunity:
    ...
    def __init__(self, market_id_1: str, market_name_1: str,
                 market_id_2: str, market_name_2: str,
                 correlation: float, divergence_pct: float,
                 z_score: float, direction: str,
...
class StatisticalArbStrategy:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.correlation_breakdown_threshold = config.get('stat_arb_correlation_breakdown', 0.5)
    ...
    def update_market_prices(self, markets: List[Dict[str, Any]],
                            prices_dict: Dict[str, Dict[str, float]]) -> None:
        """
    ...
    def analyze_pair(self, market_id_1: str, market_id_2: str,
                    market_name_1: str, market_name_2: str) -> Optional[StatisticalArbOpportunity]:
        """
    ...
    def find_opportunities(self, markets: List[Dict[str, Any]],
                          prices_dict: Dict[str, Dict[str, float]]) -> List[StatisticalArbOpportunity]:
        """
        ...
        market_names = {
            m.get('id', m.get('market_id', 'unknown')): 
            m.get('question', m.get('name', 'unknown'))
            for m in markets
        }
    ...
    def should_exit(self, pair_id: str) -> Tuple[bool, str]:
        ...
        if direction == "market1_high":
            ...
            spread_change_pct = ((entry_spread - current_spread) / abs(entry_spread)) * 100
        else:  # market2_high
            # We bet market2 will decrease or market1 will increase
            # Profit when spread increases (becomes less negative)
            spread_change_pct = ((current_spread - entry_spread) / abs(entry_spread)) * 100
    ...
    def enter_position(self, opportunity: StatisticalArbOpportunity,
