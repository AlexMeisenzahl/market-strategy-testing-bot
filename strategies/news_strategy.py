...
class NewsOpportunity:
    ...
    def __init__(self, market_id: str, market_name: str,
                 direction: str, price_movement: float,
                 volume_spike: float, volatility: float,
                 current_price: float):
        """
...
class NewsStrategy:
    ...
    def update_market_data(self, market_id: str, yes_price: float,
    ...
    def detect_rapid_price_movement(self, market_id: str) -> Tuple[float, str]:
        ...
        """
        if market_id not in self.recent_prices or len(self.recent_prices[market_id]) < 2:
            return 0.0, "neutral"
    ...
    def calculate_volatility(self, market_id: str) -> float:
        ...
        """
        if market_id not in self.recent_prices or len(self.recent_prices[market_id]) < 5:
            return 0.0
    ...
    def analyze(self, market_data: Dict[str, Any],
                price_data: Dict[str, float]) -> Optional[NewsOpportunity]:
        """
        ...
        is_volume_spike, volume_spike_pct = self.volume_trackers[market_id].detect_volume_spike(
    ...
    def find_opportunities(self, markets: List[Dict[str, Any]],
                          prices_dict: Dict[str, Dict[str, float]]) -> List[NewsOpportunity]:
        """
    ...
    def enter_position(self, opportunity: NewsOpportunity,
                       trade_size: float) -> Dict[str, Any]:
        """
        Enter a position on a news opportunity
        
        Args:
            opportunity: NewsOpportunity to trade
        ...
        position = {
            ...
            'volume_spike': opportunity.volume_spike,
            'price_movement': opportunity.price_movement,
        ...
        self.logger.log_trade(
            ...
            status=f"{self.strategy_name}_{opportunity.direction}_entered_vol{opportunity.volume_spike:.0f}%"
        )
