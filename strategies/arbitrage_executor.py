...
class ArbitrageExecutor:
    ...
    def execute_two_way(self, opportunity: ArbitrageOpportunity) -> Dict[str, Any]:
        ...
        """
        logger.info(f"Executing 2-way arbitrage (profit: ${opportunity.expected_profit:.2f})")
    ...
    def execute_three_way(self, opportunity: ArbitrageOpportunity) -> Dict[str, Any]:
        ...
        Returns:
            Execution result dictionary
        """
        logger.info(f"Executing 3-way arbitrage (profit: ${opportunity.expected_profit:.2f})")
        ...
        for i, leg in enumerate(sorted_legs, start=1):
            logger.info(f"Executing leg {i}: {leg.exchange} {leg.action} {leg.market_id}")
    ...
    def execute_multi_leg(self, opportunity: ArbitrageOpportunity) -> Dict[str, Any]:
        ...
        logger.info(f"Executing multi-leg arbitrage ({num_legs} legs, profit: ${opportunity.expected_profit:.2f})")
        ...
        # Execute each leg sequentially
        for i, leg in enumerate(sorted_legs, start=1):
            logger.info(f"Executing leg {i}/{num_legs}: {leg.exchange} {leg.action} {leg.market_id}")
