...
def main():
    ...
    console.print("\n[bold cyan]═══════════════════════════════════════════════════════════════[/bold cyan]")
    console.print("[bold cyan]     POLYMARKET ARBITRAGE BOT - PAPER TRADING DEMO           [/bold cyan]")
    ...
    for market in markets:
        ...
        if prices:
            ...
            console.print(f"[green]✓[/green] Scanned: {market['question']} - YES: ${prices['yes']:.3f}, NO: ${prices['no']:.3f}")
    ...
    if opportunities:
        console.print(f"[yellow]⚠️  Found {len(opportunities)} arbitrage opportunities![/yellow]\n")
        ...
        for opp in opportunities:
            ...
            console.print(Panel(opp_text, title="Arbitrage Opportunity", border_style="yellow"))
    ...
    stats_table.add_row("API Usage", f"{rate_stats['current']}/{rate_stats['max']} ({rate_stats['percentage']:.0f}%)")
    ...
    console.print("[green]✓ Demo complete! Run 'python3 bot.py' for the full dashboard.[/green]\n")
