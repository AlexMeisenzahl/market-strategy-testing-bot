...
def test_notification_system():
    ...
    try:
        ...
        rate_limiter = NotificationRateLimiter(
            max_per_minute=5, max_per_hour=20, cooldown_seconds=30
        )
        ...
        quiet_hours = QuietHours(
            enabled=False, start_time="23:00", end_time="07:00", timezone="UTC"
        )
        ...
        config = {
            ...
            "notifications": {
                "desktop": {
                    "enabled": True,
                    "event_types": {"trade": True, "opportunity": True, "error": True},
                },
