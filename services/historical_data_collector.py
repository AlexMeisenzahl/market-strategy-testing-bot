...
class HistoricalDataCollector:
    ...
    def collect_crypto_history(self, symbol: str, days: int = 365) -> Dict:
        ...
        try:
            ...
            self.logger.info(f"✓ Collected {inserted_count} {symbol} price records")
    ...
    def collect_polymarket_history(self, market_id: str, days: int = 90) -> Dict:
        ...
        try:
            ...
            self.logger.info(f"✓ Collected {len(records)} Polymarket price records")
            ...
            return {"success": False, "market_id": market_id, "error": str(e)}
    ...
    def fill_gaps(self, symbol: str, start_date: datetime, end_date: datetime) -> Dict:
        ...
        try:
            ...
            existing_data = CryptoPriceHistory.get_history(symbol, start_ts, end_ts)
            ...
            for i in range(len(existing_data) - 1):
                time_diff = (
                    existing_data[i + 1]["timestamp"] - existing_data[i]["timestamp"]
                )
            ...
            if not gaps:
                ...
                return {"success": True, "symbol": symbol, "gaps_filled": 0}
    ...
    def update_latest_data(self, symbols: List[str]) -> Dict:
        ...
        self.logger.info(f"✓ Updated {successful}/{len(symbols)} symbols")
