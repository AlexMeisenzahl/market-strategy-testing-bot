...
class OrderTimeoutHandler:
    ...
    def monitor_order(self, order_id: str, exchange: str,
        ...
        start_time = time.time()
        check_interval = min(5, timeout_seconds / 10)  # Check every 5s or 10% of timeout
        ...
        while True:
            ...
            if elapsed >= timeout_seconds:
                self.logger.warning(
                    f"Order {order_id} timeout after {elapsed:.1f}s"
                )
    ...
    def monitor_order_async(self, order_id: str, exchange: str,
