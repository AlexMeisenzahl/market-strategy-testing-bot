...
class EmergencyKillSwitch:
    ...
    def activate_kill_switch(
        self, reason: str, close_positions: bool = False, activated_by: str = "system"
    ) -> Dict:
        """
    ...
    def deactivate_kill_switch(self, admin_password: str = None) -> Dict:
        ...
        try:
            ...
            if not self.is_active():
                return {"status": "error", "message": "Kill switch is not active"}
    ...
    def get_status(self) -> Dict:
        ...
        try:
            ...
            status = {"active": is_active, "timestamp": datetime.utcnow().isoformat()}
