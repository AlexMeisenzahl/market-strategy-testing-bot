...
class StrategySelector:
    ...
    def _calculate_score(self, performance: Dict) -> float:
        ...
        try:
            ...
            sharpe_score = (
                performance["sharpe"] * SHARPE_SCALING_FACTOR * 0.3
            )  # Scale sharpe
        ...
        try:
            ...
            for strategy in strategies:
                ...
                ranked_strategies.append(
                    {"id": strategy_id, "name": strategy_name, "score": score}
                )
            ...
            for i, strategy in enumerate(ranked_strategies[:3]):
                if i < len(allocation_percentages):
                    ...
                    # Update in database
                    Strategy.update(strategy["id"], allocated_capital=allocation)
            ...
            return {"allocations": {}, "total_allocated": 0, "error": str(e)}
