...
class TradeVerifier:
    ...
    def verify_trade(self, order_id: str, exchange: str,
                    expected_price: float = None,
                    expected_size: float = None) -> Dict:
        """
        ...
        try:
            ...
            if expected_size and filled_size < expected_size * 0.99:
                ...
                status = VerificationStatus.PENDING if fill_status == 'PENDING' else VerificationStatus.FAILED
            else:
            ...
            if expected_size and abs(filled_size - expected_size) > expected_size * 0.01:
    ...
    def get_verification_statistics(self) -> Dict:
        ...
        slippages = [
            v['slippage_pct'] for v in self.verification_history
        ...
        return {
            ...
            'verification_rate': (verified_count / len(self.verification_history)) * 100,
