...
class StrategyOptimizer:
    ...
    def optimize_strategy(self, strategy_name: str, param_ranges: Dict,
        ...
        for i, combo in enumerate(combinations, 1):
            ...
            self.logger.info(
                f"Testing combination {i}/{total_combinations}: {params}"
            )
    ...
    def optimize_multiple_strategies(self, strategies: Dict[str, Dict],
    ...
    def sensitivity_analysis(self, strategy_name: str, param_ranges: Dict,
                           focus_param: str) -> Dict:
        """
        ...
        self.logger.info(
            f"Performing sensitivity analysis on {focus_param}..."
        )
        
        # Fix all parameters except focus_param at their first value
        fixed_params = {
            k: v[0] for k, v in param_ranges.items() if k != focus_param
        }
