...
class DataValidator:
    ...
    def validate_polymarket_price(
        self, market_id: str, our_price: float, api_price: float = None
    ) -> Dict:
        """
        ...
        try:
            ...
            return {"valid": False, "market_id": market_id, "error": str(e)}

    def check_data_freshness(
        self, market_id: str, last_update_timestamp: Optional[datetime] = None
    ) -> bool:
        """
    ...
    def validate_market_liquidity(
        self, market_id: str, liquidity: float, min_liquidity: float = 1000.0
    ) -> bool:
        """
    ...
    def validate_before_trade(
        ...
        try:
            ...
            # Overall validation
            all_valid = (
                price_validation["valid"] and data_fresh and liquidity_sufficient
            )
