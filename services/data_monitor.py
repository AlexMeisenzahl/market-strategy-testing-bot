...
class DataPipelineMonitor:
        ...
        try:
            ...
            if self.last_websocket_message:
                ...
                if time_since_message > self.websocket_timeout:
                    ...
                    status = "degraded"
                    message = (
                        f"Slow updates ({time_since_message:.1f}s since last message)"
                    )
                else:
                    status = "healthy"
    ...
    def monitor_api_health(self) -> Dict:
        ...
        try:
            ...
            avg_response_time = sum(self.api_response_times) / len(
    ...
    def record_websocket_disconnect(self):
        ...
        logger.warning(
            f"WebSocket disconnected (reconnect #{self.websocket_reconnect_count})"
        )
    ...
    def get_health_status(self) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "details": {"websocket": websocket_health, "api": api_health},
                "timestamp": datetime.utcnow().isoformat(),
            }
