...
class StrategyHealthMonitor:
    ...
    def check_strategy_health(self, strategy: Dict) -> Dict:
        ...
        try:
            ...
            daily_loss_pct = (
                abs(daily_pnl / portfolio_value * 100) if portfolio_value > 0 else 0
            )
            ...
            if (
                total_trades >= self.min_trades_for_winrate
    ...
    def _auto_disable_strategy(self, strategy: Dict, reason: str):
        ...
        try:
            ...
            Strategy.update(
                strategy_id, enabled=0, auto_disabled=1, disable_reason=reason
            )
