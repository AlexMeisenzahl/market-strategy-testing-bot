...
class AlertSystem:
    ...
    def _check_alert_condition(
        ...
        try:
            if alert_type == AlertType.PRICE.value:
                ...
                current_price = market_data.get("prices", {}).get(market_id, {}).get("yes", 0)
                ...
                strategy_pnl = market_data.get("strategies", {}).get(strategy_name, {}).get("pnl", 0)
    ...
    def _evaluate_condition(self, current: float, condition: str, threshold: float) -> bool:
        """
