...
class BacktestingEngine:
    ...
    def __init__(self, initial_capital: float = 10000.0,
                 slippage_pct: float = 0.1, fee_pct: float = 0.2):
        """
    ...
    def run_backtest(self, strategy: Any, start_date: datetime,
                    end_date: datetime, symbol: str = 'bitcoin') -> Dict:
        """
    ...
    def _evaluate_strategy_signal(self, strategy: Any, current_data: Dict,
                                  historical_data: List[Dict]) -> Optional[str]:
        """
