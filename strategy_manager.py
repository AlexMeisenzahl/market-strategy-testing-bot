...
class StrategyManager:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.enabled_strategies = strategy_config.get('enabled', [
    ...
    def _calculate_capital_allocation(self, strategy_config: Dict[str, Any]) -> Dict[str, float]:
        """
    ...
    def _initialize_strategies(self) -> None:
        ...
        for strategy_name in self.enabled_strategies:
            ...
            try:
                ...
                strategy_config['allocated_capital'] = self.capital_allocation[strategy_name]
    ...
    def run_all_strategies(self, markets: List[Dict[str, Any]], 
                          prices_dict: Dict[str, Dict[str, float]]) -> Dict[str, List[Any]]:
        """
    ...
    def execute_best_opportunities(self, all_opportunities: Dict[str, List[Any]]) -> Dict[str, int]:
        """
    ...
    def compare_strategies(self) -> Dict[str, Any]:
        ...
        for strategy_name, strategy in self.strategies.items():
            ...
            if allocated_capital > 0 and stats.get('total_actual_profit', 0) != 0:
                roi_pct = (stats.get('total_actual_profit', 0) / allocated_capital) * 100
            elif allocated_capital > 0 and stats.get('total_expected_profit', 0) != 0:
                roi_pct = (stats.get('total_expected_profit', 0) / allocated_capital) * 100
            
            # Win rate
            win_rate = 0.0
            if stats.get('opportunities_found', 0) > 0:
                win_rate = (stats.get('opportunities_taken', 0) / 
                           stats.get('opportunities_found', 0)) * 100
            
            # Average profit per trade
            avg_profit = 0.0
            if stats.get('opportunities_taken', 0) > 0:
                total_profit = stats.get('total_actual_profit', 
                                       stats.get('total_expected_profit', 0))
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        total_opportunities = sum(s['opportunities_found'] for s in strategy_stats.values())
        ...
        total_active_positions = sum(s['active_positions'] for s in strategy_stats.values())
        
        # Overall ROI
        overall_roi = (total_profit / self.total_capital * 100) if self.total_capital > 0 else 0.0
    ...
    def get_portfolio_summary(self) -> Dict[str, Any]:
        ...
        for strategy_name, strategy in self.strategies.items():
            ...
            summary['strategies'][strategy_name] = {
                ...
                'current_profit': stats.get('total_actual_profit', 
                                           stats.get('total_expected_profit', 0)),
