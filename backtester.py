...
class BacktestTrade:
    ...
    def __init__(self, timestamp: datetime, market: str, yes_price: float, 
                 no_price: float, trade_size: float):
        """
        ...
        self.profit_pct = (self.profit / self.total_cost) * 100 if self.total_cost > 0 else 0
...
class Backtester:
    ...
    def load_historical_data(self, date_range: Optional[Tuple[datetime, datetime]] = None,
                            filepath: str = "historical_data.csv") -> List[Dict[str, Any]]:
        """
    ...
    def simulate_strategy(self, strategy: str, data: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
    ...
    def generate_backtest_report(self) -> str:
        ...
        if results['opportunities_found'] > 0:
            trade_pct = (results['opportunities_traded'] / results['opportunities_found'] * 100)
