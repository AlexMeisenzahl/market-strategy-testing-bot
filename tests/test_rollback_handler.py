...
class TestRollbackHandler:
    ...
    def test_rollback_opportunity_processes_legs_in_reverse_order(self):
        ...
        print(
            "✓ test_rollback_opportunity_processes_legs_in_reverse_order: Reverse order confirmed"
        )
    ...
    def test_rollback_opportunity_continues_even_if_individual_legs_fail(self):
        ...
        print(
            "✓ test_rollback_opportunity_continues_even_if_individual_legs_fail: Continues on failure"
        )
