...
class TestArbitrageTracker:
    ...
    def test_initial_state(self):
        ...
        assert (
            self.tracker.opportunities_found == 0
        ), "Should start with 0 opportunities"
        assert (
            self.tracker.opportunities_executed == 0
        ), "Should start with 0 executions"
        ...
        assert (
            len(self.tracker.execution_history) == 0
    ...
    def test_win_rate_calculation_accurate(self):
        ...
        self.tracker.record_execution(
            {"market_id": "m1", "market_name": "M1", "profit": 10.0}
        )
        self.tracker.record_execution(
            {"market_id": "m2", "market_name": "M2", "profit": 5.0}
        )
        self.tracker.record_execution(
            {"market_id": "m3", "market_name": "M3", "profit": -3.0}
        )
        self.tracker.record_execution(
            {"market_id": "m4", "market_name": "M4", "profit": 8.0}
        )
        ...
        print(
            f"✓ test_win_rate_calculation_accurate: {actual_win_rate}% == {expected_win_rate}%"
        )
    ...
    def test_win_rate_all_wins(self):
        ...
        self.tracker.record_execution(
            {"market_id": "m3", "market_name": "M3", "profit": 8.0}
        )
    ...
    def test_average_profit_calculation(self):
        ...
        self.tracker.record_execution(
            {"market_id": "m2", "market_name": "M2", "profit": 20.0}
        )
        self.tracker.record_execution(
            {"market_id": "m3", "market_name": "M3", "profit": 30.0}
        )
        ...
        print(
            f"✓ test_average_profit_calculation: ${actual_average} == ${expected_average}"
        )
    ...
    def test_average_profit_with_losses(self):
        ...
        print(
            f"✓ test_average_profit_with_losses: ${actual_average:.2f} ≈ ${expected_average}"
        )

    def test_average_profit_handles_zero_executions(self):
        """Test average profit returns 0 when no executions"""
        assert (
            self.tracker.average_profit == 0.0
        ), "Average profit should be 0 when no executions"

        print(
            "✓ test_average_profit_handles_zero_executions: Returns 0 for empty history"
        )
    ...
    def test_get_metrics_returns_valid_data(self):
        ...
        self.tracker.record_opportunity({"market_id": "m1", "market_name": "M1"})
        self.tracker.record_execution(
            {"market_id": "m1", "market_name": "M1", "profit": 15.0}
        )
        ...
        print(
            "✓ test_get_metrics_returns_valid_data: All metrics keys present and accurate"
        )
    ...
    def test_execution_history_stored(self):
        ...
        assert (
            history[2]["market_name"] == "Market 3"
        ), "Third record name should be Market 3"
    ...
    def test_net_profit_calculation(self):
        ...
        self.tracker.record_execution(
            {"market_id": "m1", "market_name": "M1", "profit": 20.0}
        )
        self.tracker.record_execution(
            {"market_id": "m2", "market_name": "M2", "profit": 15.0}
        )
        self.tracker.record_execution(
            {"market_id": "m3", "market_name": "M3", "profit": -8.0}
        )
        ...
        assert (
            metrics["net_profit"] == expected_net_profit
        ), f"Net profit should be {expected_net_profit}"

        print(
            f"✓ test_net_profit_calculation: Net profit ${metrics['net_profit']} == ${expected_net_profit}"
        )
