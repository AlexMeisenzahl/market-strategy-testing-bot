...
class TestMarketValidator:
    ...
    def test_validate_market_aligned(self):
        ...
        assert validation['valid'] is True  # Should be aligned (price high, reality met)
    ...
    def test_validate_market_mispriced(self):
        ...
        current_prices = {
            'BTC': {
                'price_usd': Decimal('105000')  # But BTC is already above 100k!
            }
        }
        ...
        print(f"✓ test_validate_market_mispriced: {validation['profit_potential_pct']:.1f}% profit")
...
class TestCryptoPriceManager:
    ...
    def test_initialization(self):
        ...
        manager = CryptoPriceManager(logger=self.logger, log_dir=self.test_logs_dir, config=self.config)
