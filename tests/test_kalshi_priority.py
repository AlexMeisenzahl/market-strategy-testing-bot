...
class TestKalshiPriority:
    ...
    def test_sort_legs_kalshi_first_moves_kalshi_to_front(self):
        ...
        print("✓ test_sort_legs_kalshi_first_moves_kalshi_to_front: Kalshi moved to front")
    ...
    def test_sort_legs_kalshi_first_multiple_kalshi_legs(self):
        ...
        print("✓ test_sort_legs_kalshi_first_multiple_kalshi_legs: Multiple Kalshi legs handled")
    ...
    def test_sort_legs_kalshi_first_already_first(self):
        ...
        print("✓ test_sort_legs_kalshi_first_already_first: Already correct order maintained")
    ...
    def test_validate_kalshi_first_passes_when_kalshi_first(self):
        ...
        print("✓ test_validate_kalshi_first_passes_when_kalshi_first: Validation passed")
    ...
    def test_validate_kalshi_first_fails_when_kalshi_not_first(self):
        ...
        print("✓ test_validate_kalshi_first_fails_when_kalshi_not_first: Validation failed correctly")
    ...
    def test_validate_kalshi_first_passes_when_no_kalshi(self):
        ...
        assert validate_kalshi_first(opportunity) == True
        print("✓ test_validate_kalshi_first_passes_when_no_kalshi: No Kalshi validation passed")
