...
class TestArbitrageTypes:
    ...
    def test_arbitrage_type_enum_has_all_types(self):
        ...
        print(
            "✓ test_arbitrage_type_enum_has_all_types: All types present with correct values"
        )
    ...
    def test_arbitrage_leg_validates_required_fields(self):
        ...
        print(
            "✓ test_arbitrage_leg_validates_required_fields: Valid leg created successfully"
        )
    ...
    def test_arbitrage_leg_rejects_invalid_action(self):
        ...
        try:
            ...
            print(
                "✓ test_arbitrage_leg_rejects_invalid_action: Invalid action rejected"
            )
    ...
    def test_arbitrage_leg_rejects_negative_price(self):
        ...
        try:
            ...
            print(
                "✓ test_arbitrage_leg_rejects_negative_price: Negative price rejected"
            )
    ...
    def test_arbitrage_leg_rejects_negative_quantity(self):
        ...
        try:
            ...
            print(
                "✓ test_arbitrage_leg_rejects_negative_quantity: Negative quantity rejected"
            )
    ...
    def test_arbitrage_opportunity_identifies_kalshi_first(self):
        ...
        print(
            "✓ test_arbitrage_opportunity_identifies_kalshi_first: Kalshi-first detected"
        )
    ...
    def test_arbitrage_opportunity_identifies_non_kalshi_first(self):
        ...
        print(
            "✓ test_arbitrage_opportunity_identifies_non_kalshi_first: Non-Kalshi-first detected"
        )
