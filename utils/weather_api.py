...
class WeatherAPI:
    ...
    def _make_request(self, endpoint: str, params: Optional[Dict] = None) -> Optional[Dict]:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                self.logger.log_error(f"Weather API request failed (attempt {attempt + 1}/{self.max_retries}): {e}")
    ...
    def get_current_weather(self, location: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            weather_data = {
                ...
                'temperature_f': self._celsius_to_fahrenheit(props.get('temperature', {}).get('value')),
    ...
    def get_forecast(self, location: str, days: int = 7) -> Optional[List[Dict[str, Any]]]:
        """
        ...
        try:
            ...
            if not forecast_data or not forecast_data.get('properties', {}).get('periods'):
                return None
            
            periods = forecast_data['properties']['periods'][:days * 2]  # Each day has 2 periods
    ...
    def get_temperature_forecast(self, location: str, target_date: datetime) -> Optional[Dict[str, float]]:
        """
    ...
    def get_precipitation_probability(self, location: str, target_date: datetime) -> Optional[float]:
        """
        ...
        probs = [f['precipitation_probability'] for f in matching_forecasts if f['precipitation_probability']]
