...
class APIResponse:
    ...
    @staticmethod
    def error(error_message: str, error_code: Optional[str] = None, status_code: int = 400, meta: Optional[Dict] = None) -> tuple:
        """
    ...
    @staticmethod
    def paginated(data: list, page: int, per_page: int, total: int, meta: Optional[Dict] = None) -> Dict:
        """
...
def handle_api_errors(f):
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            return APIResponse.error(str(e), error_code='PERMISSION_DENIED', status_code=403)
            ...
            return APIResponse.error('Internal server error', error_code='INTERNAL_ERROR', status_code=500)
    
    return wrapper


# Convenience function
def create_response(success: bool = True, data: Any = None, error: Optional[str] = None, 
    ...
    if success:
        ...
        return APIResponse.error(error or 'Unknown error', status_code=status_code, **kwargs)
