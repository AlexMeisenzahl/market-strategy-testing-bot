...
class TaxPosition:
    ...
    def __init__(self, date_acquired: datetime, date_sold: datetime, 
                 description: str, proceeds: float, cost_basis: float):
        """
...
class TaxExporter:
    ...
    def __init__(self, config: Dict[str, Any], log_dir: str = "logs"):
        ...
        self.open_positions: Dict[str, List[Tuple[datetime, float, float]]] = {}  # market -> [(date, size, cost)]
        ...
        try:
            with open(output_path, 'w', newline='') as f:
                ...
                for position in positions:
                    writer.writerow({
                        'Date Acquired': position.date_acquired.strftime('%m/%d/%Y'),
