...
def upgrade():
    ...
    op.create_index('idx_crypto_symbol_timestamp', 'crypto_price_history', ['symbol', 'timestamp'])
    ...
    op.create_index('idx_notif_channel_user', 'notification_channels', ['user_id', 'channel_type'])
    ...
    op.create_index('idx_notif_pref_user_type', 'notification_preferences', ['user_id', 'notification_type'])
