...
class BotRunner:
    ...
    def _check_alerts(self, markets: List[Dict[str, Any]], prices_dict: Dict[str, Dict[str, float]]) -> None:
        """
        ...
        try:
            ...
            for position in self.risk_manager.get_all_positions():
                ...
                if market_id in current_prices:
                    ...
                    action = self.risk_manager.check_stop_loss_take_profit(market_id, current_price)
                    
                    if action:
                        # Close position
                        closed_position = self.risk_manager.close_position(market_id, current_price)
